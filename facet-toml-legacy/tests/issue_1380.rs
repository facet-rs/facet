...
"#;
    ...
    let result: Manifest = facet_toml_legacy::from_str(toml).unwrap();
...
"#;
    ...
    let result: ManifestBroken = facet_toml_legacy::from_str(toml).unwrap();
...
"#;
    ...
    let result: Config = facet_toml_legacy::from_str(toml).unwrap();
