/// Test for issue #1434: Spanned<T> in multi-variant untagged enums (TOML)
///
/// This test verifies that the fix in facet-solver also works for TOML
use facet::Facet;
use facet_reflect::Spanned;
use facet_toml_legacy as toml;
...
#[test]
fn test_toml_multi_scalar_spanned_bool() {
...
#[test]
fn test_toml_multi_scalar_spanned_number() {
...
#[test]
fn test_toml_multi_scalar_spanned_string() {
