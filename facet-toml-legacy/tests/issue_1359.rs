...
"#;
    ...
    let result2 = facet_toml_legacy::from_str::<Manifest>(toml2);
...
"#;
    ...
    let result = facet_toml_legacy::from_str::<Package>(toml);
    assert!(result.is_ok());
...
"#;
    ...
    let result2 = facet_toml_legacy::from_str::<Package>(toml2);
