...
export const testbed_send_schemas: import("@bearcove/roam-core").ServiceSendSchemas = {
  schemas: new Map<bigint, import("@bearcove/roam-postcard").WireSchema>([
    ...
    [0x2a6c000b74f002d0n, {
      ...
      kind: {
        ...
        variants: [{
          ...
          name: "Data",
          index: 2,
          payload: { tag: "newtype", type_ref: { tag: "concrete", type_id: 0x0a96b404b4d79d67n, args: [] } },
        }],
      },
    }],
    [0xbe8e93d72e564214n, {
      id: 0xbe8e93d72e564214n,
      type_params: [],
      kind: { tag: "tuple", elements: [{ tag: "concrete", type_id: 0x2a6c000b74f002d0n, args: [] }] },
    }],
    [0x40a42c5eb693e46cn, {
      id: 0x40a42c5eb693e46cn,
      type_params: [],
      kind: {
        tag: "enum",
        name: "Result",
        variants: [{
          name: "Ok",
          index: 0,
          payload: { tag: "newtype", type_ref: { tag: "concrete", type_id: 0x2a6c000b74f002d0n, args: [] } },
        }, {
          name: "Err",
          index: 1,
          payload: { tag: "newtype", type_ref: { tag: "concrete", type_id: 0xeb41a85ae6648f0cn, args: [] } },
    ...
    [0x8c4ffd5124ed20edn, {
      ...
      kind: {
        ...
        variants: [{
          name: "Ok",
          index: 0,
          payload: { tag: "newtype", type_ref: { tag: "concrete", type_id: 0x552eb11103d7a727n, args: [] } },
        }, {
          name: "Err",
          index: 1,
          payload: { tag: "newtype", type_ref: { tag: "concrete", type_id: 0xeb41a85ae6648f0cn, args: [] } },
    ...
    [0x757e79a22acce4fdn, {
      id: 0x757e79a22acce4fdn,
      type_params: [],
      kind: { tag: "tuple", elements: [{ tag: "concrete", type_id: 0x0a96b404b4d79d67n, args: [] }] },
    }],
    [0xd0c227aa64344cf6n, {
      id: 0xd0c227aa64344cf6n,
      type_params: [],
      kind: {
        tag: "enum",
        name: "Result",
  ...
  methods: new Map<bigint, import("@bearcove/roam-core").MethodSendSchemas>([
    ...
    [0xe08f0f5254e7a997n, {
      ...
      argsRootRef: { tag: "concrete", type_id: 0xbe8e93d72e564214n, args: [] },
      responseDepIds: [
        0x40a42c5eb693e46cn,
        0xeb41a85ae6648f0cn,
        0x6d7dce914ee150e8n,
      ...
      responseRootRef: { tag: "concrete", type_id: 0x40a42c5eb693e46cn, args: [] },
    }],
    [0x598518523a6266bfn, {
      argsDepIds: [0xdbefcb75f8046566n, 0x281c5be4f2ee63b4n],
      argsRootRef: { tag: "concrete", type_id: 0xdbefcb75f8046566n, args: [] },
    ...
    [0x7d55a713ad612bf2n, {
      ...
      responseRootRef: { tag: "concrete", type_id: 0x8c4ffd5124ed20edn, args: [] },
    }],
    [0x44056c7842fa336cn, {
      argsDepIds: [0x757e79a22acce4fdn, 0x0a96b404b4d79d67n],
      argsRootRef: { tag: "concrete", type_id: 0x757e79a22acce4fdn, args: [] },
      responseDepIds: [
        0xd0c227aa64344cf6n,
        0xeb41a85ae6648f0cn,
        0x6d7dce914ee150e8n,
      ...
      responseRootRef: { tag: "concrete", type_id: 0xd0c227aa64344cf6n, args: [] },
    }],
    [0x5136d8f01a5f496cn, {
