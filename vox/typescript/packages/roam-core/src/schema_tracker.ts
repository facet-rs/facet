...
import { buildPlan, resolveTypeRef } from "@bearcove/roam-postcard";
...
export interface MethodSendSchemas {
  ...
  argsRootRef: import("@bearcove/roam-postcard").TypeRef;
  /** Root TypeRef for the response schema. */
  responseRootRef: import("@bearcove/roam-postcard").TypeRef;
}
...
export interface ServiceSendSchemas {
  ...
  schemas: Map<bigint, import("@bearcove/roam-postcard").Schema>;
...
export class SchemaSendTracker {
  ...
  prepareSchemas(
    ...
    const schemas = newDeps
      ...
      .filter((s): s is import("@bearcove/roam-postcard").Schema => s !== undefined);
