//! Cross-platform local IPC for vox.
//!
...
///
/// ```
/// use vox_local::path_to_pipe_name;
///
/// let pipe = path_to_pipe_name("/home/user/project/.tracey/daemon.sock");
/// // Returns something like r"\\.\pipe\vox-a1b2c3d4e5f6..."
/// ```
#[cfg(windows)]
