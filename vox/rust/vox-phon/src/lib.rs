...
pub mod schema;
pub use schema::{
    AuxiliaryRoot, COMPACT_SCHEMA_REF, DecodeProgram, Decoded, SchemaBundle, build_decode_program,
    decode_compat, decode_owned_with_program, decode_with_program, decode_with_program_retained,
    ...
    schema_root_id, to_self_describing, to_self_describing_by_root,
};
