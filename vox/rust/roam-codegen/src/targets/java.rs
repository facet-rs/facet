...
fn generate_runtime_helpers() -> String {
    ...
    out.push_str("        writeUVarint(out, 0); // RapaceError::User\n");
    ...
    out.push_str("        ByteArrayOutputStream out = new ByteArrayOutputStream();\n");
    out.push_str("        writeUVarint(out, 1); // Result::Err\n");
    out.push_str("        writeUVarint(out, 1); // RapaceError::UnknownMethod\n");
    out.push_str("        return out.toByteArray();\n");
    out.push_str("    }\n\n");
    ...
    out.push_str("        ByteArrayOutputStream out = new ByteArrayOutputStream();\n");
    out.push_str("        writeUVarint(out, 1); // Result::Err\n");
    out.push_str("        writeUVarint(out, 2); // RapaceError::InvalidPayload\n");
    out.push_str("        return out.toByteArray();\n");
    out.push_str("    }\n\n");
