...
cargo build -p vox-shm --bin guest_process --all-features
...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  swift build --package-path swift/vox-runtime --product shm-bootstrap-client
  swift build --package-path swift/vox-runtime --product shm-guest-client
