...
use facet_reflect::{Partial, ReflectError, TypePlan};
...
// Note: The old alloc_shape_unsized test was removed because the new API
// requires T: Sized at compile time, so unsized types are rejected at compile
