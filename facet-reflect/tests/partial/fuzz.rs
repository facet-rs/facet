...
proptest! {
    ...
    fn fuzz_simple_struct(
        ...
        let mut partial: Partial<'_, '_> = Partial::alloc::<SimpleStruct>().unwrap();
        let mut u32_idx = 0;
        let mut str_idx = 0;
    ...
    fn fuzz_list_ops(
        ...
        let mut partial: Partial<'_, '_> = Partial::alloc::<WithList>().unwrap();
        let mut idx = 0;
    ...
    fn fuzz_map_ops(
        ...
        let mut partial: Partial<'_, '_> = Partial::alloc::<WithMap>().unwrap();
        let mut key_idx = 0;
        let mut val_idx = 0;
...
fn wip_fuzz_drop_after_partial_init() {
    ...
    let partial: Partial<'_, '_> = Partial::alloc::<FuzzTarget>().unwrap();
...
fn wip_fuzz_reg_test_1() {
    let mut partial: Partial<'_, '_> = Partial::alloc::<facet_value::Value>().unwrap();
...
fn wip_fuzz_reg_test_2() {
    let mut partial: Partial<'_, '_> = Partial::alloc::<FuzzTarget>().unwrap();
