...
/// Machine code + continuation relocations for the ASYNC (suspend/resume) lane,
/// generated by `build.rs` from `stencils/async_ops.rs`. Empty off the native
/// copy-and-patch targets.
