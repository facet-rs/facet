...
pub use ir::{
    ...
    EnumOp, EnumVariantOp, Lowered, LoweredEffectStats, LoweredMemProgramStats,
    LoweredProgramStats, MapOp, MapThunks, MemIntrinsic, MemOp, MemProgram, MemProgramStats,
    MemoryRegion, Op, OpaqueOp, OpaqueThunks, OptionOp, OptionThunks, PointerOp, PointerThunks,
    Program, ProgramStats, ResourceAccess, ResourceEffect, ResultOp, ResultThunks, ScalarRunOp,
    ScalarSegment, SeqOp, SeqThunks, SetOp, SetThunks, SkipOp, TypedMemoryAccess,
    TypedMemoryEffect, ValueIntrinsic, ValueOp, ValueProgram, canonical_mem_intrinsic_counts,
    canonical_mem_lowered, canonical_mem_lowered_effect_stats,
    ...
    canonical_value_intrinsic_counts, canonical_value_lowered_effect_stats,
    canonical_value_lowered_intrinsic_counts, canonical_value_lowered_stats,
    canonical_value_program, canonical_value_program_effect_stats, canonical_value_program_stats,
    lowered_mem_program_stats, mem_lowered_from_canonical, mem_program_from_canonical,
    mem_program_stats, value_lowered_from_canonical, value_program_from_canonical,
};
