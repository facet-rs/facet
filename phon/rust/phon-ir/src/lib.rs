...
pub use ir::{
    ...
    EnumOp, EnumVariantOp, Lowered, LoweredAnalysis, LoweredEffectStats, LoweredMemProgramStats,
    ...
    canonical_mem_lowered, canonical_mem_lowered_analysis, canonical_mem_lowered_effect_stats,
    ...
    canonical_value_intrinsic_counts, canonical_value_lowered_analysis,
    canonical_value_lowered_effect_stats, canonical_value_lowered_intrinsic_counts,
    canonical_value_lowered_stats, canonical_value_program, canonical_value_program_effect_stats,
    canonical_value_program_stats, lowered_mem_program_stats, mem_lowered_from_canonical,
