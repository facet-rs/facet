...
fn op_name(op: &Op) -> &'static str {
    match op {
        ...
        Op::OrderedBeginProbe { .. } => "OrderedBeginProbe",
        Op::OrderedProbeKey { .. } => "OrderedProbeKey",
        Op::OrderedProbeValue { .. } => "OrderedProbeValue",
        Op::OrderedEmpty { .. } => "OrderedEmpty",
        Op::OrderedBeginInsert { .. } => "OrderedBeginInsert",
        Op::OrderedInsertInspect { .. } => "OrderedInsertInspect",
        Op::OrderedInsertAdvance { .. } => "OrderedInsertAdvance",
        Op::OrderedInsertCommit { .. } => "OrderedInsertCommit",
        Op::OrderedBeginIterate { .. } => "OrderedBeginIterate",
        Op::OrderedIterateRow { .. } => "OrderedIterateRow",
