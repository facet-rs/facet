...
fn test_deserialize_primitive_list() {
    ...
    let numbers: Vec<u64> = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_deserialize_struct_list() {
    ...
    let people: Vec<Person> = facet_yaml_legacy::from_str(yaml).unwrap();
    assert_eq!(
        people,
        vec![
            Person {
...
fn test_deserialize_empty_list() {
    ...
    let empty_list: Vec<u64> = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_deserialize_nested_lists() {
    ...
    let nested: Vec<Vec<u64>> = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_deserialize_arc_slice_i32() {
    ...
    let arc_slice: Arc<[i32]> = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_deserialize_arc_slice_string() {
    ...
    let arc_slice: Arc<[String]> = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_deserialize_arc_slice_struct() {
    ...
    let people: Arc<[Person]> = facet_yaml_legacy::from_str(yaml).unwrap();
