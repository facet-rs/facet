...
fn test_ipv4_addr_deserialize() -> Result<()> {
    ...
    let result: Ipv4Root = facet_yaml_legacy::from_str(yaml)?;
...
fn test_ipv6_addr_deserialize() -> Result<()> {
    let yaml = "value: '::1'";
    let result: Ipv6Root = facet_yaml_legacy::from_str(yaml)?;
...
fn test_ip_addr_deserialize_v4() -> Result<()> {
    ...
    let result: IpRoot = facet_yaml_legacy::from_str(yaml)?;
...
fn test_ipv4_addr_deserialize_invalid() {
    ...
    let result = facet_yaml_legacy::from_str::<Ipv4Root>(yaml);
...
fn test_ipv6_addr_deserialize_invalid() {
    ...
    let result = facet_yaml_legacy::from_str::<Ipv6Root>(yaml);
