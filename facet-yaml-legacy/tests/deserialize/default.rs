...
fn test_struct_level_default() {
    ...
    let s: DefaultStruct = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_field_level_default_no_function() {
    ...
    let s: FieldDefault = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_field_level_default_function() {
    ...
    let s: FieldDefaultFn = facet_yaml_legacy::from_str(yaml).unwrap();
...
fn test_nested_struct_with_defaults() {
    ...
    let s: Root = facet_yaml_legacy::from_str(yaml).unwrap();
    ...
    let s2: Root = facet_yaml_legacy::from_str(yaml2).unwrap();
...
fn test_default_with_complex_expression() {
    ...
    let config: ServerConfig = facet_yaml_legacy::from_str(yaml).unwrap();
    ...
    let config2: ServerConfig = facet_yaml_legacy::from_str(yaml2).unwrap();
...
"#;
    ...
    let value: MixedOptions = facet_yaml_legacy::from_str(yaml).unwrap();
