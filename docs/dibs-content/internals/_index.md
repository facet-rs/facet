...
dibs maintains [`__dibs_*` tables](/dibs/internals/meta-tables/) to record source locations (file/line/column), doc comments, and which migration created what. This powers richer tooling in the CLI, editors, and admin UIs - but it's separate from your app schema and ignored during diffing.
