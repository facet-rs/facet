...
- [Args](@/guide/showcases/args.md) — Command-line argument parsing with facet-args
- [Assertions](@/guide/showcases/assert.md) — Structural equality with facet-assert
- [Diagnostics](@/guide/showcases/compile_errors.md) — Rich error messages with source spans
- [Diffing](@/guide/showcases/diff.md) — Structural diffing with facet-diff
