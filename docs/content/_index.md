...
<a class="section-card" href="https://github.com/bearcove/weavy"><span>weavy →</span><small>Share lowered programs across interpreters and copy-and-patch backends.</small></a>
<a class="section-card" href="https://github.com/bearcove/vox"><span>vox →</span><small>Define Rust-native RPC services with cross-language codegen and transports.</small></a>
</div>
