+++
title = "Reference"
description = "Complete catalogs of every #[facet(...)] attribute and a format-support matrix across all facet crates."
sort_by = "weight"
weight = 2
...
<a class="guide-card" href="/reference/container-attributes/">
  ...
  <p class="description"><code>rename_all</code>, <code>transparent</code>, <code>deny_unknown_fields</code>, <code>opaque</code>, <code>metadata_container</code>, <code>pod</code>, <code>invariants</code>, and more.</p>
</a>
...
<a class="guide-card" href="/reference/field-attributes/">
  ...
  <p class="description"><code>rename</code>, <code>default</code>, the <code>skip_*</code> family, <code>flatten</code>, <code>sensitive</code>, <code>proxy</code>, and more.</p>
</a>
...
[Ecosystem map](/ecosystem/) lists every facet crate, and the
[guide](/guide/) walks through tasks end to end.
