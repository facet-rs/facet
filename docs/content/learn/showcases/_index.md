...
- [JSON](@/learn/showcases/json.md) — facet-json serialization and deserialization
- [YAML](@/learn/showcases/yaml.md) — facet-yaml examples
- [KDL](@/learn/showcases/kdl.md) — facet-kdl with KDL-specific attributes
