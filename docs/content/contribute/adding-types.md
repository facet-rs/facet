...
This guide is for contributing `Facet` implementations to the facet repository. If you just want to use a type that doesn't implement `Facet`, see [When a type doesn't implement Facet](@/guide/type-support.md#when-a-type-doesn-t-implement-facet).
