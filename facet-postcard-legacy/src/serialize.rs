...
/// ```
/// use facet::Facet;
/// use facet_postcard_legacy::to_writer;
///
/// #[derive(Debug, Facet)]
/// struct Point {
///     x: i32,
...
/// ```
/// use facet::Facet;
/// use facet_postcard_legacy::{to_writer_fallible, Writer, SerializeError};
///
/// #[derive(Debug, Facet)]
/// struct Point {
///     x: i32,
...
/// ```
/// use facet::Facet;
/// use facet_postcard_legacy::to_slice;
///
/// #[derive(Debug, Facet)]
/// struct Point {
///     x: i32,
...
///
/// ```
/// use facet_postcard_legacy::{Writer, SerializeError};
///
/// struct PooledWriter {
