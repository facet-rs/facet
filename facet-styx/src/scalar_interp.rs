...
//! this deserializer: a second reader of Styx documents (vix's type-directed
//! decoder drives `StyxParser` itself, with no deserializer to hint it) must
//! interpret scalars identically or the two disagree about what a document
//! says.
