...
fn test_parse_simple_circle() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse circle SVG");
...
fn test_parse_multiple_shapes() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse multi-shape SVG");
...
fn test_parse_grouped_elements() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse grouped SVG");
...
fn test_parse_text_elements() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse text SVG");
...
fn test_parse_path_element() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse path SVG");
...
fn test_parse_style_element() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse style SVG");
...
fn test_parse_defs_element() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse defs SVG");
...
fn test_parse_polygon_and_polyline() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse polygon/polyline SVG");
...
fn test_parse_ellipse() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse ellipse SVG");
...
fn test_parse_minimal_svg() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse minimal SVG");
...
fn test_parse_dashed_lines() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse dashed SVG");
...
fn test_parse_nested_groups() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse nested groups SVG");
...
fn test_parse_pikchr_style_diagram() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse pikchr-style SVG");
...
fn test_bootstrap_icon() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse Bootstrap icon SVG");
...
fn test_feather_icon_style() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse Feather icon SVG");
...
fn test_svg_with_use_element() {
    ...
    match facet_xml_legacy::from_str::<Svg>(svg_str) {
        Ok(svg) => {
...
fn test_svg_with_transform() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse transform SVG");
...
fn test_svg_with_opacity() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse opacity SVG");
    assert_eq!(svg.children.len(), 1);
}
...
fn test_svg_use_element_supported() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse use element SVG");
    assert_eq!(svg.children.len(), 2); // defs and use
    if let Some(facet_svg_legacy::SvgNode::Use(use_elem)) = svg.children.last() {
...
fn test_svg_image_element_supported() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse image element SVG");
    assert_eq!(svg.children.len(), 1);
    if let Some(facet_svg_legacy::SvgNode::Image(img)) = svg.children.first() {
...
fn test_svg_title_element_supported() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse title element SVG");
    assert_eq!(svg.children.len(), 2); // title and rect
    if let Some(facet_svg_legacy::SvgNode::Title(title)) = svg.children.first() {
...
fn test_svg_desc_element_supported() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse desc element SVG");
    assert_eq!(svg.children.len(), 2); // desc and rect
    if let Some(facet_svg_legacy::SvgNode::Desc(desc)) = svg.children.first() {
...
fn test_svg_symbol_element_supported() {
    ...
    let svg: Svg = facet_xml_legacy::from_str(svg_str).expect("Failed to parse symbol element SVG");
    assert!(!svg.children.is_empty());
    if let Some(facet_svg_legacy::SvgNode::Defs(defs)) = svg.children.first()
        && let Some(facet_svg_legacy::SvgNode::Symbol(sym)) = defs.children.first()
    {
