...
[![Coverage Status](https://coveralls.io/repos/github/facet-rs/facet-svg-legacy/badge.svg?branch=main)](https://coveralls.io/github/facet-rs/facet?branch=main)
[![crates.io](https://img.shields.io/crates/v/facet-svg-legacy.svg)](https://crates.io/crates/facet-svg-legacy)
[![documentation](https://docs.rs/facet-svg-legacy/badge.svg)](https://docs.rs/facet-svg-legacy)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/facet-svg-legacy.svg)](./LICENSE)
