...
fn showcase_basic_struct(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&person).unwrap();
...
fn showcase_nested_structs(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&company).unwrap();
...
fn showcase_externally_tagged_enum(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&messages).unwrap();
...
fn showcase_internally_tagged_enum(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&responses).unwrap();
...
fn showcase_adjacently_tagged_enum(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&events).unwrap();
...
fn showcase_untagged_enum(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&values).unwrap();
...
fn showcase_maps_string_keys(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&string_map).unwrap();
...
fn showcase_maps_integer_keys(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&int_map).unwrap();
...
fn showcase_tuple_struct(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&point).unwrap();
...
fn showcase_multiline_strings(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&document).unwrap();
...
fn showcase_complex_nested_config(runner: &mut ShowcaseRunner) {
    ...
    let yaml_output = facet_yaml::to_string(&app_config).unwrap();
...
fn showcase_roundtrip(runner: &mut ShowcaseRunner) {
    ...
    // Serialize to YAML
    let yaml_output = facet_yaml::to_string(&original).unwrap();

    // Deserialize back from YAML
    let roundtrip: Config = facet_yaml::from_str(&yaml_output).unwrap();
