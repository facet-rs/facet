...
pub struct SerializeOptions {
    ...
    /// # use facet_xml_legacy::{to_string_with_options, SerializeOptions};
    ///
    /// #[derive(Facet)]
    /// struct Text {
    ///     #[facet(xml::attribute)]
...
/// # use facet::Facet;
/// # use facet_xml_legacy as xml;
/// # use facet_xml_legacy::to_string;
/// #[derive(Facet)]
/// struct Person {
///     #[facet(xml::attribute)]
///     id: u32,
...
/// # use facet::Facet;
/// # use facet_xml_legacy as xml;
/// # use facet_xml_legacy::to_string_pretty;
/// #[derive(Facet)]
/// struct Person {
///     #[facet(xml::attribute)]
///     id: u32,
...
/// # use facet::Facet;
/// # use facet_xml_legacy as xml;
/// # use facet_xml_legacy::to_writer;
/// #[derive(Facet)]
/// struct Person {
///     #[facet(xml::attribute)]
///     id: u32,
...
/// # use facet::Facet;
/// # use facet_xml_legacy as xml;
/// # use facet_xml_legacy::to_writer_pretty;
/// #[derive(Facet)]
/// struct Person {
///     #[facet(xml::attribute)]
///     id: u32,
...
/// # use facet::Facet;
/// # use facet_xml_legacy as xml;
/// # use facet_xml_legacy::{to_writer_with_options, SerializeOptions};
/// #[derive(Facet)]
/// struct Person {
///     #[facet(xml::attribute)]
///     id: u32,
